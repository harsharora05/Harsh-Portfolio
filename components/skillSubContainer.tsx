...
export function SkillSubContainer(props: {
    ...
    return <div className="w-[290px] abtxsm:w-[350px] abtsm:w-[310px] abtmd:w-[270px] bg-white px-6 py-4 shadow-sm shadow-gray-100 border border-gray-50 hover:border-blue-200   rounded-xl flex flex-col gap-4" >
